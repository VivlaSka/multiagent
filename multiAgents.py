...
class MinimaxAgent(MultiAgentSearchAgent):
  ...
  def recurrentMiniMaxCalc(self, ghosts, currGameState):
      ...
      # Wanneer er een of meerdere ghosts niet kunnen bewegen, moet pacman toch een evaluatie terugkrijgen
      if len(next_g_moves) == 0:
          if len(ghosts) == 1:
            return self.evaluationFunction(currGameState)
          else:
            # Alle mogelijke leaf nodes van de zoektree moeten gevonden worden
        ...
        # min waarde halen uit alle mogelijke staat waarden teruggekregen voor elke ghost.
...
class ExpectimaxAgent(MultiAgentSearchAgent):
  ...
  def getAction(self, currGameState):
    ...
    for pacman_move in pacman_moves:
        # volgende mogelijke staat volgens pacmans beweging
        next_state = currGameState.generateSuccessor(0, pacman_move)
        ...
        # deze is de expectimax waarde van de mogelijke PacMan moves.
